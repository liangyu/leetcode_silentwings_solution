package LC1501_1800;
import java.util.*;
public class LC1649_CreateSortedArraythroughInstructions {
    /**
     ...
     *
     * Return the total cost to insert all elements from instructions into nums. Since the answer may be large, return
     * it modulo 10^9 + 7
     *
